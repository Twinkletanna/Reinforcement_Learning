...
#                         # print('changed alpha')
    ...
    def get_poly_phi(self,state,k,z):
        ...
        for each in c:
            ...
            for i in range(len(each)):
                poly_part*=s[i]**each[i]
            # print(poly_part)
            poly_vec.append(poly_part)
        poly_vec=np.array(poly_vec).ravel()
    ...
    #         r.append(x)
    #         plt.plot(x)
    #         plt.savefig('./cpgraph/cpsarsa'+str(i)+str(alpha)+str(eps)+'.jpg')
    #         plt.clf()
    #         np.save('./cpgraph/cpsarsa_trial'+str(i)+'.npy',x)
    ...
    #         r.append(x)
    #         plt.plot(x)
    #         plt.savefig('./cpgraph/cpq'+str(i)+str(alpha)+str(eps)+'.jpg')
    #         plt.clf()
    #         np.save('./cpgraph/cpqlearn_trial'+str(i)+'.npy',x)
